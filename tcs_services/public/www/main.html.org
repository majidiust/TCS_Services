...
<a href="javascript:void(0);" id="open-shimg001ortcuts"><span class="icon-thumbs"></span></a>
...
<section role="main" id="main">
    ...
    <div class="with-padding">
        ...
        <p class="wrapped right-icon icon-info-round"
           style="float: right;direction: rtl;margin-bottom: 40px;margin-top: 20px;line-height:50px;">
            این جدول نمایش دهنده ترددهای صورت گرفته است.
        

	<p onclick="reload();" class="wrapped orange-gradient" style="color:black;cursor:pointer;line-height:50px;float:right;margin-top:20px;margin-bottom:40px; font-family:tahome;">بروزرسانی</p>
        <br/>
</P>
...
<ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right">
    ...
    <li><a href="contactus.html" class="shortcut-contacts" title="تماس با ما">تماس با ما</a></li>
</ul>
...
<script>
    ...
    function loadData(pageSize){
		...
		var count = parseInt(result.pageCount);
    ...
    function reload(page, pageSize){
		...
		if(exist)
		    if(page > 29)
		    {
			setTimeout(function(){reload(page - 1, pageSize);}, 500);
